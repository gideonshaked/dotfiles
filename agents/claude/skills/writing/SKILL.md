...
Run these over your own draft as you finish it, and again whenever you revise.
...
Rule 6 is the one people drop. The rules serve clarity, so break one when following it would make a sentence clumsy or change its meaning. It is what licenses keeping a word that some list bans when that word is the right technical term. A rule that has started fighting the meaning has stopped doing its job.
